                    ...
                    if (navigator.geolocation) {
                        navigator.geolocation.getCurrentPosition(pos => {
                            ...
                            if (!userLocationMarker.current) {
                                userLocationMarker.current = new Marker({ map, icon: { path: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z', fillColor: '#4285F4', fillOpacity: 1, strokeWeight: 0, scale: 0.8, anchor: new window.google.maps.Point(12, 12)} });
                            }
